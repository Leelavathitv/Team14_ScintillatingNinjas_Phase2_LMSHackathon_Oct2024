...
Feature: Manage Program - Pagination
  ...
  @ProgramNextPagination @PaginationTC_01
  Scenario: Verify Admin is able to click Next page link
    When Admin clicks Next page link on the program table
    Then Admin should see the Pagination has "Next" active link

  @ProgramLastPagination @PaginationTC_02
  ...
  @ProgramPreviosPagination @PaginationTC_03
  ...
  @ProgramFirstPagination @PaginationTC_04
