...
public class ClassPage {
	...
	private static final Logger logger = (Logger) LogManager.getLogger(ClassPage.class);
	...
	String batchUrl;
	int count = 0;
	public static String batchName, classTopic, classDescription, status, classDate, staffName;
	static String classNameStr;
	...
	@FindBy(xpath = "//mat-card-title[@class='mat-card-title']//div[normalize-space()='Manage Class']")
